...
public interface IUserSessionManager extends IAuthSessionManager {
	...
	void clearSession();
	void createSession(final String userName, final String password, final AsyncCallback<UserSession> callback);
	UserSession getSession();
	// <from, to>
	ISlotManager2<UserSession, UserSession> getUserSessionChangedSlots();

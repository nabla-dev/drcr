 ...
 *
 */
public class StringReportParameterValue implements IReportParameterValue {

	private String	name;
	private String	value;

	public StringReportParameterValue() {}

	public StringReportParameterValue(String name, String value) {
		this.name = name;
		this.value = value;
	}

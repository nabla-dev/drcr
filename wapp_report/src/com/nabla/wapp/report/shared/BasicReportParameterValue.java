 ...
 *
 */
public class BasicReportParameterValue<T> implements IReportParameterValue {

	protected String	name;
	protected T		value;

	public BasicReportParameterValue() {}

	public BasicReportParameterValue(String name, T value) {
		this.name = name;
		this.value = value;
	}

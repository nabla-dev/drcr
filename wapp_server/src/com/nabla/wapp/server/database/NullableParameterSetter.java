 ...
 *
 */
public class NullableParameterSetter implements IStatementSetter {

	@Override
	public int prepare(StringBuilder sql, int parameterIndex, Object value) {
		return ((NullableParameter)value).prepare(sql, parameterIndex);
	}

	@Override
	public int setValue(PreparedStatement stmt, int parameterIndex, Object value) throws SQLException {
		return ((NullableParameter)value).setValue(stmt, parameterIndex);
	}

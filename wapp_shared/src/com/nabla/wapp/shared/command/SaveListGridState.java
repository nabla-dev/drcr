...
public class SaveListGridState implements IAction<VoidResult> {
	...
	public SaveListGridState() {}

	public SaveListGridState(final String listGridName, final String state) {
		this.listGridName = listGridName;
		this.state = state;
	}

	public String getListGridName() {
		return listGridName;
	}

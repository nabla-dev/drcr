 ...
 *
 */
public class FixedAssetCategoryTreeGrid extends TreeGridItem {

	private static final Logger		logger = LoggerFactory.getLog(FixedAssetCategoryTreeGrid.class);
//	private final SelectionDelta	delta = new SelectionDelta();

	public FixedAssetCategoryTreeGrid() {
		super();
		setCanEdit(true);

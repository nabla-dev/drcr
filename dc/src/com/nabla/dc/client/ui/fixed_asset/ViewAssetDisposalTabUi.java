 ...
 *
 */
public class ViewAssetDisposalTabUi extends BindedTabDisplay<Tab> implements ViewAssetDialog.IDisposalTabDisplay {

	interface Binder extends UiBinder<Tab, ViewAssetDisposalTabUi> {}
	private static final Binder	uiBinder = GWT.create(Binder.class);

	@UiField(provided=true)
	final AssetDisposalModel	model;

	public ViewAssetDisposalTabUi(final int assetId) {

 ...
 *
 */
public class ImportSettingsWizardCompletedPageUi extends StaticWizardPageUi implements ImportSettingsWizard.ICompletedPage {

	interface Binder extends UiBinder<Html, StaticWizardPageUi> {}
	private static final Binder	uiBinder = GWT.create(Binder.class);

	public ImportSettingsWizardCompletedPageUi() {

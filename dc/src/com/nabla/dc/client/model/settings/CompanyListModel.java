...
public class CompanyListModel extends CModel<CompanyRecord> {
	...
	static public class Fields {
		public static String name() { return ICompany.NAME; }
		public static String active() { return ICompany.ACTIVE; }
	}
	...
	public CompanyListModel() {
		...
		setFields(
			...
			new IdField(),
			new TextField(ICompany.NAME, ICompany.NAME_CONSTRAINT, FieldAttributes.REQUIRED),
			new BooleanField(ICompany.ACTIVE)
				);
	}

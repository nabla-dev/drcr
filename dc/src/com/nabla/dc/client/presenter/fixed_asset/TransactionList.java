...
import com.nabla.dc.client.ui.fixed_asset.TransactionListUi;
...
public class TransactionList extends AbstractTabPresenter<TransactionList.IDisplay> {
	...
	public TransactionList(final IDisplay display) {
		super(display);
	}

	public TransactionList(final Integer assetId, final String assetName) {
		this(new TransactionListUi(assetId, assetName));
	}

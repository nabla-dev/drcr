...
import com.nabla.dc.client.ui.settings.CompanyUserListUi;
...
*/
	...
	public CompanyUserList(final Integer companyId, final IDisplay display) {
		...
		display.getCommands().setObjectId(companyId);
	}
...
//		printerManager.bind(cmd, this, BuiltInReports.USER_LIST);
	...
	private final ISlot1<UserRecord> onEditUserRoles = new ISlot1<UserRecord>() {
		...
		public void invoke(final UserRecord record) {
			new RoleDefinitionDialog(new UserDefinitionModel(companyId, record.getId()), record.getName()).revealDisplay();
		}
	};

...
public class UpdateFixedAssetCategory implements IAction<StringResult> {
	...
	public UpdateFixedAssetCategory(final Integer companyId, final Integer assetCategoryId, final String balanceSheetCategory, final Boolean active) {

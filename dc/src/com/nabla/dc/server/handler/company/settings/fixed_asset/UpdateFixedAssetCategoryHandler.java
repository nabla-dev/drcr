...
import com.nabla.dc.shared.command.company.settings.fixed_asset.UpdateFixedAssetCategory;
 ...
 *
 */
public class UpdateFixedAssetCategoryHandler extends AbstractHandler<UpdateFixedAssetCategory, StringResult> {
...
//	private final SqlInsert<UpdateCompanyFixedAssetCategory> sql = new SqlInsert<UpdateCompanyFixedAssetCategory>(UpdateCompanyFixedAssetCategory.class, SqlInsertOptions.OVERWRITE);
	...
	public UpdateFixedAssetCategoryHandler() {
		super(true);
	}

	@Override
	public StringResult execute(final UpdateFixedAssetCategory record, final IUserSessionContext ctx) throws DispatchException, SQLException {

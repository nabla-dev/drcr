...
import com.nabla.dc.shared.command.fixed_asset.FetchAssetAcquisition;
 ...
 *
 */
public class FetchAssetAcquisitionHandler extends AbstractFetchHandler<FetchAssetAcquisition> {
...
" WHERE t.id=?"
	...
	@Override
	public FetchResult execute(final FetchAssetAcquisition cmd, final IUserSessionContext ctx) throws DispatchException, SQLException {
